...
let light;
var content =
  "Welcome to Haunted Hopper! Behind each door you will find the opportunity to save one of your friends. But don't be fooled, each mistake you make will cost them their life.";
let textOpen = false;
let last = false;
